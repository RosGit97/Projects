            ...
            <ImageBackground source={fundo} resizeMode='cover' style={styles.img} >
                ...
                <ScrollView style={styles.body}>
                    <View style={{
                        ...
                        <ImageBackground source={info} resizeMode='cover' style={{ height: 80, width: 80, }} />
                        <Text style={{ textAlign: 'justify', width: '98%', flex: 1, flexDirection: 'row', color: '#fff' }}>Se você já passou por uma situação de furto, roubo ou foi vítima de um outro crime? então
                            ...
                            <TouchableOpacity style={{ alignItems: 'center', justifyContent: 'center', height: 13, }}><Text style={{ alignItems: 'center', justifyContent: 'center', height: 13, color: 'blue' }}> AQUI </Text></TouchableOpacity>
                            para aprender a fazer uma denúncia.
                        </Text>

                        <Text style={{ textAlign: 'justify', flex: 1, flexDirection: 'row', color: '#fff', marginTop: 80 }}>
                            Desenvolvido por:
                        </Text>
                        ...
                        <Text style={{
                            ...
                            Clementina Sorte & Rosário Alexandre
                        </Text>
